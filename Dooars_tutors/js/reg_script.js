document.addEventListener('DOMContentLoaded', function () {
        ...
        const cityLandmarks = {
            "Alipurduar": [
                ...
                { name: "Maa seva nursing Home", lat: 26.485427, lng: 89.524466, type: "hospital", icon: "🏥" },
                { name: "Lions Eye Hospital", lat: 26.481195, lng: 89.527979, type: "hospital", icon: "🏥" },
                { name: "St. Marry Nursing Home", lat: 26.481747, lng: 89.527298, type: "hospital", icon: "🏥" },
                { name: "Alipurduar High School", lat: 26.474014, lng: 89.520783, type: "school", icon: "🏫" },
                { name: "Alipurduar HIgh School PlayGround", lat: 26.473812, lng: 89.521489, type: "ground", icon: "🌱" },
                { name: "SuryaNagar Playground", lat: 26.497634, lng: 89.522696, type: "ground", icon: "🌱" },
                { name: "Nabin Club", lat: 26.508985, lng: 89.531407, type: "ground", icon: "🌱" },
                { name: "Chinnamasta KaliBari", lat: 26.520666, lng: 89.534218, type: "temple", icon: "🛕" },
                ...
                { name: "Alipurduar Junction", lat: 26.523263, lng: 89.533703, type: "transport", icon: "🚉" },
                { name: "Madhab Mistonno Bhandar", lat: 26.495286, lng: 89.527119, type: "shop", icon: "🍮" },
                { name: "Om Ladge", lat: 26.495229, lng: 89.527870, type: "hotel&restrurent", icon: "🧳" },
                { name: "Winni Cakes & more", lat: 26.495445, lng: 89.528516, type: "shop", icon: "🍰" },
                { name: "Dutta Hero", lat: 26.495418, lng: 89.529168, type: "showroom", icon: "🏍️" },
            ],
            "Coochbehar": [
